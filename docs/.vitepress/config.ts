...
export default defineConfig({
  ...
  themeConfig: {
    ...
    editLink: {
      pattern: 'https://github.com/MelihAltintas/vue3-openlayers/edit/main/docs/:path'
    },
    footer: {
      message: 'Released under the <a href="https://github.com/MelihAltintas/vue3-openlayers/blob/main/LICENSE">MIT License</a>.',
      copyright: 'Copyright © 2023-present <a href="https://github.com/MelihAltintas/vue3-openlayers">MelihAltintas</a>'
    },
    nav: [
      { text: 'Home', link: '/' },
