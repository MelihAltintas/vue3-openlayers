...
export type FeatureAnimation = (Blink | Bounce | Drop | Fade | None | Null | Path | Shake | Show | Slide | Teleport
    | Throw | Zoom | ZoomOut)

export type FeatureAnimationOptions = Options | BlinkOptions | BounceOptions | DropOptions | FadeOptions
    | PathOptions | ShakeOptions | SlideOptions | ThrowOptions | ZoomOptions | ZoomOutOptions
